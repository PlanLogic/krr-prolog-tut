...
cancel___2__1__0__2([A|M], D, C, F) :-
    ...
    ->  'chr debug_event'(apply([A], [F], \+D\=G, true)),
        ...
        nb_getval('$chr_store_global_list_user____not_holds_all___2', J),
        'chr sbag_del_element'(J, A, K),
        b_setval('$chr_store_global_list_user____not_holds_all___2', K),
...
not_holds(A, B) :-
    ...
    'chr gen_id'(D),
    nb_getval('$chr_store_global_list_user____not_holds___2', E),
    b_setval('$chr_store_global_list_user____not_holds___2', [C|E]),
...
cancel___2__1(E, A, F) :-
    ...
    ;   nb_getval('$chr_store_global_list_user____not_holds_all___2', D)
    ),
    !,
...
all_holds(A, B) :-
    ...
    b_setval('$chr_store_global_list_user____all_holds___2', [C|E]),
...
cancel___2__3__0__4([A|N], D, C, F) :-
    ...
    ->  'chr debug_event'(apply([A], [F], \+D\=G, true)),
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', L),
...
not_holds___2__1(J, A, L) :-
    ...
    ;   nb_getval('$chr_store_global_list_user____all_not_holds___3', D)
    ),
    member(E, D),
...
all_holds(A, B, C) :-
    ...
    b_setval('$chr_store_global_list_user____all_holds___3', [D|F]),
...
cancel___2__4__0__5([A|P], E, C, G) :-
    ...
    ->  'chr debug_event'(apply([A],
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', N),
...
not_holds___2__2(E, A, F) :-
    ...
    ;   nb_getval('$chr_store_global_list_user____if_then_or_holds___3', D)
    ),
    !,
...
or_holds(A, B) :-
    ...
    b_setval('$chr_store_global_list_user____or_holds___2', [C|E]),
...
all_holds___3__3__0__6([A|U], E, F, C, J) :-
    ...
    ->  'chr debug_event'(apply([A],
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', S),
...
all_not_holds___3__2__0__5([A|S], D, E, C, I) :-
    ...
    ->  'chr debug_event'(apply([A],
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', Q),
    ...
    ;   all_not_holds___3__2__0__5(S, D, E, C, I)
    ).
...
all_not_holds___3__1__0__4([A|V], E, F, C, J) :-
    ...
    ;   all_not_holds___3__1__0__4(V, E, F, C, J)
    ).
...
or_holds(A, B, C) :-
    ...
    b_setval('$chr_store_global_list_user____or_holds___3', [D|G]),
...
all_not_holds___3__3__0__6([A|Y], E, F, C, J) :-
    ...
    ->  'chr debug_event'(apply([A],
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', U),
    ...
    ;   all_not_holds___3__3__0__6(Y, E, F, C, J)
    ).
...
if_then_or_holds___3__0(J, O, A, L) :-
    ...
    (   copy_fluent(G, H, I, K),
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', T),
    ...
    ;   member(W, O),
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', F1),
...
if_then_or_holds___3__0(J, U, A, L) :-
    ...
    ;   member(W, U, I1),
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', G1),
...
if_then_or_holds___3__0(_, A, _, E) :-
    ...
    nb_getval('$chr_store_global_list_user____if_then_or_holds___3', L),
...
if_then_or_holds___3__0(I, A, K, E) :-
    ...
    setarg(2, E, removed),
    term_variables(term(L, M, N), Q),
    nb_getval('$chr_store_global_list_user____if_then_or_holds___3', O),
...
if_then_or_holds___3__0(C, E, A, B) :-
    ...
    nb_getval('$chr_store_global_list_user____if_then_or_holds___3', N),
...
if_then_or_holds___3__0(H, P, A, I) :-
    ...
    ;   member(Q, P, Z),
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', X),
...
if_then_or_holds___3__0(H, P, A, I) :-
    ...
    ;   member(Q, P),
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', W),
...
all_not_holds___3__0__0__3([A|R], D, E, C, I) :-
    ...
    ;   all_not_holds___3__0__0__3(R, D, E, C, I)
    ).
...
inst(G, F) :-
    \+ ( term_variables(G, X),
         term_variables(F, Y),
         bound_free(Y, X, V, W),
         copy_term_vars(W, F, F1),
         \+ no_global_bindings(G=F1, V)
       ).
...
if_then_or_holds___4__0(F, A, H, B, C) :-
    ...
    term_variables(O, P),
    nb_getval('$chr_store_global_list_user____if_then_or_holds___4', Q),
...
all_holds___3__2__0__5([A|U], D, E, C, I) :-
    ...
    ->  'chr debug_event'(apply([A],
        ...
        b_setval('$chr_store_global_list_user____if_then_or_holds___3', R),
...
all_holds___2__0(B, C, A) :-
    'chr debug_event'(try([A], [], true, all_holds(B, 0#=0, C))),
    !,
    'chr debug_event'(apply([A], [], true, all_holds(B, 0#=0, C))),
    'chr debug_event'(remove(A)),
...
cancelled(A, B) :-
    ...
    'chr gen_id'(D),
    nb_getval('$chr_store_global_list_user____cancelled___2', E),
    b_setval('$chr_store_global_list_user____cancelled___2', [C|E]),
